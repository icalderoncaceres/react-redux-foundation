...
var LOAD_CHAT_SUCCESS = exports.LOAD_CHAT_SUCCESS = 'LOAD_CHAT_SUCCESS';
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_hoist_non_react_statics__ = __webpack_require__(78);
...
exports.loadChats = undefined;

var _ChatApi = __webpack_require__(88);

var _ChatApi2 = _interopRequireDefault(_ChatApi);
...
/* use ACtions  */
var chatApi = new _ChatApi2.default();

/* const get all chats  */
var getAllChats = function getAllChats(chats) {
  return {
    type: _ActionTypes.LOAD_CHAT_SUCCESS,
    chats: chats
  };
};
...
var loadChats = exports.loadChats = function loadChats() {
  return function (dispatch) {
    ...
    return chatApi.fetchAllChats(function (getChats, err) {
      if (!err) {
...
var _configureStore = __webpack_require__(53);

var _configureStore2 = _interopRequireDefault(_configureStore);

var _reactRedux = __webpack_require__(28);

var _ChatActions = __webpack_require__(33);
...
/* dependencies */
store.dispatch((0, _ChatActions.loadChats)());
...
var m=__webpack_require__(15),n=__webpack_require__(6),p=__webpack_require__(2),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.call"):60104,u=q?Symbol["for"]("react.return"):60105,v=q?Symbol["for"]("react.portal"):60106,w=q?Symbol["for"]("react.fragment"):60107,x="function"===typeof Symbol&&Symbol.iterator;
...
/* report system js */
var _conf = __webpack_require__(43);
...
function _base_url() {
  ...
  /* main_url */
  var _main_url = _conf.base_url ? _conf.base_url : 'http://localhost';
...
function _get_port() {
  //retunr port
  return _conf.port ? _conf.port : process.env.PORT || '80';
}
...
*/
var aa=__webpack_require__(3),l=__webpack_require__(16),B=__webpack_require__(17),C=__webpack_require__(2),ba=__webpack_require__(18),da=__webpack_require__(19),ea=__webpack_require__(20),fa=__webpack_require__(21),ia=__webpack_require__(22),D=__webpack_require__(6);
...
var _rootReducer = __webpack_require__(69);
...
exports.default = function () {
  return (0, _redux.createStore)(_rootReducer2.default, _redux.applyMiddleware.apply(undefined, middleware));
};
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4), __webpack_require__(64)(module)))
...
var _chatReducer = __webpack_require__(70);
...
/* const */
/* deoendencies */
var rootReducer = (0, _redux.combineReducers)({ chats: _chatReducer2.default });
...
var _initialState = __webpack_require__(71);
...
exports.default = function () {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _initialState2.default.chats;
  var action = arguments[1];
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); /* import actions */
...
var ChatApi = function () {
  ...
  function ChatApi() {
    ...
    this.req = _axios2.default.create({
  ...
  _createClass(ChatApi, [{
    key: 'fetchAllChats',
    value: function fetchAllChats(success) {
      this.req.get('/api/chat.json').then(function (response) {
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } /* import app */
...
var _ItemChat = __webpack_require__(115);

var _ItemChat2 = _interopRequireDefault(_ItemChat);
...
var ChatList = function (_React$Component) {
  ...
  function ChatList() {
    ...
    /* binding */
    var _this = _possibleConstructorReturn(this, (ChatList.__proto__ || Object.getPrototypeOf(ChatList)).call(this));

    _this._nodeMsM = _this._nodeMsM.bind(_this);
    return _this;
  }
  ...
  _createClass(ChatList, [{
    key: '_nodeMsM',
    value: function _nodeMsM() {
      /* iterate */
      var _node = this.props.chats.map(function (item, i) {
        return _react2.default.createElement(_ItemChat2.default, { key: i, info: item });
      }, this);
...
ChatList.propTypes = {
  chats: _propTypes2.default.array.isRequired
};
...
var _ChatLeftPane = __webpack_require__(113);

var _ChatLeftPane2 = _interopRequireDefault(_ChatLeftPane);

var _ChatContainer = __webpack_require__(111);
...
var Chat = function (_React$Component) {
  ...
  _createClass(Chat, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'section',
        { className: 'columns is-gapless all-app-content' },
        _react2.default.createElement(_ChatLeftPane2.default, null),
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } /* import default */
...
var ChatContainer = function (_React$Component) {
  ...
  function ChatContainer() {
    ...
    return _possibleConstructorReturn(this, (ChatContainer.__proto__ || Object.getPrototypeOf(ChatContainer)).call(this)); //Call parent
  }
...
var ChatHeader = function (_React$Component) {
  ...
  function ChatHeader() {
    ...
    return _possibleConstructorReturn(this, (ChatHeader.__proto__ || Object.getPrototypeOf(ChatHeader)).call(this));
  }
  ...
  _createClass(ChatHeader, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        "div",
        { className: "column is-narrow chat-header-ls" },
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement("img", { src: global.conf.mediaApi + "img/profile_1.jpg", className: "img-rounded" })
            )
          ),
          _react2.default.createElement(
            "div",
...
var _ChatHeader = __webpack_require__(112);

var _ChatHeader2 = _interopRequireDefault(_ChatHeader);

var _ChatSearch = __webpack_require__(114);

var _ChatSearch2 = _interopRequireDefault(_ChatSearch);
...
/* class */
var ChatLeftPane = function (_React$Component) {
  _inherits(ChatLeftPane, _React$Component);

  /* parent */
  function ChatLeftPane() {
    _classCallCheck(this, ChatLeftPane);

    /* super */
    return _possibleConstructorReturn(this, (ChatLeftPane.__proto__ || Object.getPrototypeOf(ChatLeftPane)).call(this));
  }

  /* render */


  _createClass(ChatLeftPane, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'column is-4 left-pane-content' },
        _react2.default.createElement(_ChatHeader2.default, null),
        _react2.default.createElement(_ChatSearch2.default, null),
...
/* class */
var ChatSearch = function (_React$Component) {
  _inherits(ChatSearch, _React$Component);

  /* first enter */
  function ChatSearch() {
    _classCallCheck(this, ChatSearch);

    return _possibleConstructorReturn(this, (ChatSearch.__proto__ || Object.getPrototypeOf(ChatSearch)).call(this));
  }

  /* render */


  _createClass(ChatSearch, [{
    key: "render",
    value: function render() {
      return _react2.default.createElement(
        "div",
        { className: "column chat-search-ls" },
        _react2.default.createElement(
          "div",
          { className: "field" },
          _react2.default.createElement(
            ...
            _react2.default.createElement("input", { className: "input", type: "text", placeholder: "Enter text to search" }),
            _react2.default.createElement(
              "span",
...
/* Class */
var ItemChat = function (_React$Component) {
  _inherits(ItemChat, _React$Component);

  /* Constructor */
  function ItemChat() {
    _classCallCheck(this, ItemChat);

    //Super
    return _possibleConstructorReturn(this, (ItemChat.__proto__ || Object.getPrototypeOf(ItemChat)).call(this));
  }

  /* Render */


  _createClass(ItemChat, [{
    key: "render",
    value: function render() {
